...
<body>
                            ...
                            <!---side nav---->
        <div class="list-group bg-info" style="height: 100%;">
           ...
           <?php
            //<a href="discharge.php" class="list-group-item list-group-item-action bg-info text-center text-white">Report</a>
           ?>
