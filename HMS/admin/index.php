            ...
            <div class="row">
              <div class="col-md-3 bg-success mx-2" style="height:130px;">
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                                <a href="admin.php">
                                      <i class="fa fa-user-tie fa-4x my-4" style="color:white;"></i>
                                 </a>
                            </div>
              ...
              <div class="col-md-3 bg-info mx-2" style="height:130px;">
               <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                                <a href="doctor.php">
                                      <i class="fa fa-user-doctor fa-4x my-4" style="color:white;"></i>
                                 </a>
                            </div>
              ...
              <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                                <a href="patient.php">
                                      <i class="fa fa-bed-pulse fa-3x my-4" style="color:white;"></i>
                                 </a>
                            </div>
              ...
              <div class="col-md-3 bg-danger mx-2 my-2" style="height:130px;">
                     <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                                <a href="report.php">
                                      <i class="fa fa-flag fa-4x my-4" style="color:white;"></i>
                                 </a>
                            </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                                <a href="job_request.php">
                                      <i class="fa fa-book-open-reader fa-4x my-4" style="color:white;"></i>
                                 </a>
                            </div>
              ...
              <div class="col-md-3 bg-success mx-2 my-2" style="height:130px;">
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                                <a href="income.php">
                                      <i class="fa fa-indian-rupee-sign fa-4x my-4" style="color:white;"></i>
                                 </a>
                            </div>
